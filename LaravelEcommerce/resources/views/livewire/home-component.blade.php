                        ...
                        <div class="row align-items-center slider-animated-1">
                            ...
                            <div class="col-lg-7 col-md-6">
                                <div class="single-slider-img single-slider-img-1">
                                    <img class="animated slider-1-1" src="{{ asset('assets/imgs/slider')}}/{{$slider->image}}" alt="">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="tab-content wow fadeIn animated" id="myTabContent">
                    <div class="tab-pane fade show active" id="tab-one" role="tabpanel" aria-labelledby="tab-one">
                        <div class="row product-grid-4">
                            @foreach($FeateredProducts as $fproduct)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-xs-6 col-6">
                                <div class="product-cart-wrap mb-30">
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="{{ route('product.detail',['slug' => $fproduct->slug])}}">
                                                <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$fproduct->image}}" alt="" width="280px" height="280px">
                                    ...
                                    <div class="product-img-action-wrap">
                                        <div class="product-img product-img-zoom">
                                            <a href="product-details.html">
                                                <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$pproduct->image}}" alt="" width="280px" height="280px">
                    ...
                    <div class="carausel-6-columns" id="carausel-6-columns">
                        ...
                        <div class="card-1">
                            <figure class=" img-hover-scale overflow-hidden">
                                <a href="shop.html"><img src="{{ asset('assets/imgs/products')}}/{{$pproduct->image}}" alt="" width="320px" height="280px"></a>
                            </figure>
                            <h5><a href="shop.html">{{$pproduct->name}}</a></h5>
                        </div>
                       @endforeach
                ...
                <div class="carausel-6-columns-cover position-relative">
                    ...
                    <div class="carausel-6-columns carausel-arrow-center" id="carausel-6-columns-2">
                        ...
                        <div class="product-cart-wrap small hover-up">
                            <div class="product-img-action-wrap">
                                <div class="product-img product-img-zoom">
                                    <a href="{{ route('product.detail',['slug' => $lproduct->slug]) }}">
                                        <img class="default-img" src="{{ asset('assets/imgs/products')}}/{{$lproduct->image}}" alt="{{$lproduct->name}}" width="400px" height="150px">
                                        {{-- <img class="hover-img" src="{{ asset('assets/imgs/shop/product-2-2.jpg')}}" alt=""> --}}
                                    </a>
                                </div>
                                {{-- <div class="product-action-1">
