                ...
                <div class="row">
                                      ...
                                      <h2 class="title-detail">{{$product->name}}</h2>
                                        ...
                                        <div class="detail-extralink">
                                            ...
                                            <div class="product-extra-link2">
                                                <a style="width: 200px; " class="button button-add-to-cart" href="#" wire:click.prevent="store({{$product->id}} , '{{$product->name}}', {{$product->regular_price}})">Add to cart</a>
                                            ...
                                            <div class="product-cart-wrap small hover-up">
                                                <div class="product-img-action-wrap">
                                                    <div class="product-img product-img-zoom">
                                                        <a href="{{route('product.detail',$rproduct->slug)}}" tabindex="0">
                    ...
                    <div class="col-lg-3 primary-sidebar sticky-sidebar">
                        ...
                        <div class="sidebar-widget product-sidebar  mb-30 p-30 bg-grey border-radius-10">
                           ...
                           @foreach($LatestProduct as $NewProduct)
                            <div class="single-post clearfix">
                                <div class="image">
                                    <img src="{{ asset('assets/imgs/shop/thumbnail-')}}{{$NewProduct->id}}.jpg" alt="#">
                                </div>
                                <div class="content pt-10">
                                    <h6><a href="product-details.html">{{$NewProduct->name}}</a></h6>
