                            ...
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="image product-thumbnail"><img src="{{ asset('assets/imgs/shop/product-')}}{{$item->id}}-2.jpg" alt="#"></td>
                                        ...
                                        <td class="text-center" data-title="Stock">
                                            <div class="detail-qty border radius  m-auto">
                                                <a href="#" class="qty-down"  wire:click="$emit('postAdded')" wire:click.prevent="decreaseQuantity('{{$item->rowId}}')"><i class="fi-rs-angle-small-down"></i></a>
                                    ...
                                    @else 
                                    <div>Where's no Items In The Cart</div>
                                    @endif
