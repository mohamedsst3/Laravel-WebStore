                            ...
                            <div class="card-body">
                             <form wire:submit.prevent="UpdateSlider">
                                ...
                                <div class="mb-3 mt-3">
                                    ...
                                    <input type="file" name="image" id="image" class="form-control" width="300px" wire:model="newimage">
                                    @if($newimage)
                                    <img src="{{$newimage->temporaryUrl()}}" alt="" width="400px">

                                    @else
                                    <img src="{{asset('assets/imgs/slider')}}/{{$image}}" alt="" width="400px">
